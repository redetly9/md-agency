          ...
          <ul className="divide-y">
            ...
            <li className="py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <Link href="/refinance.html" className="text-gray-900">Рефинансирование ипотеки 7-13,8%</Link>
              </div>
            </li>
            <li className="py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <Link href="/arenda_s_vykupom.html" className="text-gray-900">Аренда с выкупом 7-13,8%</Link>
              </div>
            </li>
          </ul>
        </div>
